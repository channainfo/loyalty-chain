...
module loychain::partner_nft_test {
  ...
  public fun mint_card_ok(){
    ...
    test_scenario::next_tx(&mut scenario, owner);
    {
      ...
      let nft_card = partner_nft::mint_card(tier_name, card_type_name, owner, partner, ctx);
  ...
  #[test]
  #[expected_failure(abort_code=partner_nft::ERROR_NOT_PARTNER_ADDRESS)]
  public fun mint_card_ok_not_partner_address(){
    use sui::test_scenario;
    ...
    test_scenario::next_tx(&mut scenario, owner);
    {
      ...
      // Eventually crash with ERROR_NOT_PARTNER_ADDRESS
      let nft_card = partner_nft::mint_card(tier_name, card_type_name, stranger, partner, ctx);
      partner_nft::transfer_card(nft_card, receiver);
  ...
  #[test]
  #[expected_failure(abort_code=partner_nft::ERROR_MAX_SUPPLY_REACHED)]
  public fun mint_card_max_supply_reached(){
    use sui::test_scenario;
    ...
    test_scenario::next_tx(&mut scenario, owner);
    {
      ...
      // Eventually crashed with ERROR_MAX_SUPPLY_REACHED
      let nft_card = partner_nft::mint_card(tier_name, card_type_name, owner, partner, ctx);
      partner_nft::transfer_card(nft_card, receiver);
  ...
  #[test]
  public fun test_mint_and_transfer_card() {
    use sui::test_scenario;
  ...
  #[test]
  #[expected_failure(abort_code=partner_nft::ERROR_NOT_PARTNER_ADDRESS)]
  public fun test_burn_card_not_partner_address() {
    use sui::test_scenario;
  ...
  #[test]
  public fun test_mint_and_tranfer_to_member_ok(){
    use sui::test_scenario;
  ...
  #[test]
  #[expected_failure(abort_code=partner_nft::ERROR_NOT_PARTNER_ADDRESS)]
  public fun test_mint_and_tranfer_to_member_not_partner_address(){
    use sui::test_scenario;
